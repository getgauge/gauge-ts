...
import { AfterScenario, AfterSpec, AfterStep, AfterSuite, BeforeScenario, BeforeSpec, BeforeStep, BeforeSuite, ContinueOnFailure, CustomScreenGrabber, CustomScreenshotWriter, Step } from "../../src/public/decorators";
...
describe('decoators', () => {
  ...
  describe('Step', () => {
    it('should add step to stepRegistry', () => {
      Step("hello")(new Object(), '', { value: () => { console.log('hello'); } });
      expect(regsitry.isImplemented('hello')).toBeTruthy();
    });

    it('should add step with aliases to stepRegistry', () => {
      Step(["hi", "hello"])(new Object(), '', { value: () => { console.log('hello'); } });
