...
describe('HookRegistry', () => {
    ...
    describe('.add', () => {
        it('should add a given hook', () => {
            hookRegistry.addHook(HookType.BeforeSuite, new HookMethod(DUMMY_FUNC, FILE));
    ...
    describe('.get', () => {
        ...
        it('should give empty list if there is not hooks for given tag', () => {
            hookRegistry.addHook(HookType.AfterScenario, new HookMethod(DUMMY_FUNC, FILE, { tags: ['scenario'] }));
        ...
        it('should give hooks for given tag with default operator if not given', () => {
            const hook = new HookMethod(DUMMY_FUNC, FILE, { tags: ['scenario', 'spec'] });
        ...
        it('should give hooks for given tag with given operator', () => {
            const hook = new HookMethod(DUMMY_FUNC, FILE, { tags: ['scenario', 'spec'], operator:Operator.Or });
        ...
        it('should give hooks for given all hooks if no tag is given', () => {
            ...
            expect(hookRegistry.get(HookType.AfterScenario, [])[0].getMethod()).toEqual(DUMMY_FUNC);
    ...
    describe('.setInstanceForMethodsIn', () => {
        it('shooud set the instance for all methods of a given FILE', () => {
            ...
            hookRegistry.addHook(HookType.BeforeSuite, new HookMethod(DUMMY_FUNC, FILE));
            hookRegistry.addHook(HookType.AfterSuite, new HookMethod(DUMMY_FUNC, FILE_1));
