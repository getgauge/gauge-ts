...
import { RefactorRequest, RefactorResponse, ParameterPosition, FileChanges, TextDiff } from "../gen/messages_pb";
import { ProtoStepValue, Span } from "../gen/spec_pb";
...
export class RefactorProcessor extends CodeHelper {
    ...
    private refactor(oldStep: ProtoStepValue, newStep: ProtoStepValue, paramPositions: ParameterPosition[]): RefactorResponse {
