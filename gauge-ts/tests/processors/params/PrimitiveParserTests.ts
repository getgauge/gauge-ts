...
describe("PrimitiveParser", () => {
  ...
  describe("convertToNumber", () => {
    ...
    const convertToNumber = (value: string) => parser.convertToNumber(value);

    it("should not convert UUIDs", () => {
      expect(
        convertToNumber("81423165-ad04-4c7b-9f85-75d1a8aa1b0d"),
      ).toBeUndefined();
    });
  ...
  describe("convertToBoolean", () => {
    ...
    const convertToBoolean = (value: string) =>
      ...
      (parser as any).convertToBoolean(value);
